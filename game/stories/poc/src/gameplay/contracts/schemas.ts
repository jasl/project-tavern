...
const pocStoryBalanceZodSchemaV1 = z
  .strictObject({
    ...
    purchaseQuantityPerLineLimit: positiveSafeIntegerZodSchemaV1.refine((value) => value <= 999),
    menuRecipeLimit: positiveSafeIntegerZodSchemaV1,
    menuPortionsPerRecipeLimit: positiveSafeIntegerZodSchemaV1.refine((value) => value <= 999),
