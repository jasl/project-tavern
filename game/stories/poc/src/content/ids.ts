...
export const pocRejectionReasonTextIdsByCodeV1 = Object.freeze({
  "run.invalid_status": pocTextIdsV1.rejectionRunInvalidStatus,
  "run.already_started": pocTextIdsV1.rejectionRunAlreadyStarted,
  "run.not_started": pocTextIdsV1.rejectionRunNotStarted,
  "run.policy_required": pocTextIdsV1.rejectionRunPolicyRequired,
  "command.unknown_reference": pocTextIdsV1.rejectionCommandUnknownReference,
  "command.blocked_by_narrative": pocTextIdsV1.rejectionCommandBlockedByNarrative,
  "command.blocked_by_workflow": pocTextIdsV1.rejectionCommandBlockedByWorkflow,
  "policy.already_chosen": pocTextIdsV1.rejectionPolicyAlreadyChosen,
  "calendar.invalid_phase": pocTextIdsV1.rejectionCalendarInvalidPhase,
  "calendar.insufficient_ap": pocTextIdsV1.rejectionCalendarInsufficientAp,
  "calendar.phase_blocked": pocTextIdsV1.rejectionCalendarPhaseBlocked,
  "action.unavailable": pocTextIdsV1.rejectionActionUnavailable,
  "actor.insufficient_stamina": pocTextIdsV1.rejectionActorInsufficientStamina,
  "actor.stamina_at_maximum": pocTextIdsV1.rejectionActorStaminaAtMaximum,
  "tavern.preparation_limit_reached": pocTextIdsV1.rejectionTavernPreparationLimitReached,
  "inventory.invalid_quantity": pocTextIdsV1.rejectionInventoryInvalidQuantity,
  "inventory.duplicate_line": pocTextIdsV1.rejectionInventoryDuplicateLine,
  "inventory.line_limit_exceeded": pocTextIdsV1.rejectionInventoryLineLimitExceeded,
  "inventory.insufficient_cash": pocTextIdsV1.rejectionInventoryInsufficientCash,
  "inventory.insufficient_ingredient": pocTextIdsV1.rejectionInventoryInsufficientIngredient,
  "facility.unavailable": pocTextIdsV1.rejectionFacilityUnavailable,
  "facility.target_not_offered": pocTextIdsV1.rejectionFacilityTargetNotOffered,
  "facility.already_built": pocTextIdsV1.rejectionFacilityAlreadyBuilt,
  "facility.choice_committed": pocTextIdsV1.rejectionFacilityChoiceCommitted,
  "aura.already_present": pocTextIdsV1.rejectionAuraAlreadyPresent,
  "aura.not_found": pocTextIdsV1.rejectionAuraNotFound,
  "tavern.invalid_plan": pocTextIdsV1.rejectionTavernInvalidPlan,
  "tavern.plan_frozen": pocTextIdsV1.rejectionTavernPlanFrozen,
  "tavern.service_unavailable": pocTextIdsV1.rejectionTavernServiceUnavailable,
  "tavern.opening_plan_missing": pocTextIdsV1.rejectionTavernOpeningPlanMissing,
  "tavern.evening_resolved": pocTextIdsV1.rejectionTavernEveningResolved,
  "tavern.opening_active": pocTextIdsV1.rejectionTavernOpeningActive,
  "tavern.opening_missing": pocTextIdsV1.rejectionTavernOpeningMissing,
  "tavern.opening_checkpoint_blocked": pocTextIdsV1.rejectionTavernOpeningCheckpointBlocked,
  "tavern.opening_continue_not_needed": pocTextIdsV1.rejectionTavernOpeningContinueNotNeeded,
  "tavern.opening_not_ready": pocTextIdsV1.rejectionTavernOpeningNotReady,
  "workflow.conflict": pocTextIdsV1.rejectionWorkflowConflict,
  "workflow.missing": pocTextIdsV1.rejectionWorkflowMissing,
  "world.action_unavailable": pocTextIdsV1.rejectionWorldActionUnavailable,
  "world.action_wrong_phase": pocTextIdsV1.rejectionWorldActionWrongPhase,
  "narrative.inactive": pocTextIdsV1.rejectionNarrativeInactive,
  "narrative.cursor_mismatch": pocTextIdsV1.rejectionNarrativeCursorMismatch,
  "narrative.choice_required": pocTextIdsV1.rejectionNarrativeChoiceRequired,
  "narrative.choice_hidden": pocTextIdsV1.rejectionNarrativeChoiceHidden,
  "narrative.choice_disabled": pocTextIdsV1.rejectionNarrativeChoiceDisabled,
  "levy.not_due": pocTextIdsV1.rejectionLevyNotDue,
  "story.rule_rejected": pocTextIdsV1.rejectionStoryRuleRejected,
  "engine.invariant_rejected": pocTextIdsV1.rejectionEngineInvariantRejected,
