...
| `game/packages/modules/**`                                            | Game-specific modules, rules, state, commands, and tests                                                                      | [PolyForm Noncommercial 1.0.0](LICENSES/PolyForm-Noncommercial-1.0.0.txt) |
...
| Project-owned narrative, localization, art, audio, and design content | Original expressive game content in `art-source/**`, `game/packages/assets/**`, and Story content/asset directories           | [CC BY-NC-SA 4.0](LICENSES/CC-BY-NC-SA-4.0.txt)                           |
