...
This policy does not prohibit legally permitted nominative use needed to identify the original project, describe compatibility, provide attribution, or explain the source of a fork. Such references must be accurate and must not imply endorsement.

Forks and derivative projects should use distinct names and branding unless separate written permission is granted.
