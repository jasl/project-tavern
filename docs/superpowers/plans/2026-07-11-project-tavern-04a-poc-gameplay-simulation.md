...
- The package is `@project-tavern/story-poc` at `stories/poc`. There is no Sandbox, separate preview Story, or shared gameplay package.
- PoC Gameplay code may import only public Base contracts plus files inside `stories/poc/src/gameplay`; it must not import React, DOM, Web Host, Story presentation, application, tooling, `stories/e2e`, `references/`, or AIGC source archives.
...
- Create: `stories/poc/src/gameplay/contracts/values.ts`
- Create: `stories/poc/src/gameplay/contracts/ids.ts`
- Create: `stories/poc/src/gameplay/contracts/types.ts`
- Create: `stories/poc/src/gameplay/contracts/module-catalog.ts`
- Create: `stories/poc/src/gameplay/contracts/define-poc-gameplay-module.ts`
- Create: `stories/poc/src/gameplay/contracts/schemas.ts`
- Create: `stories/poc/src/gameplay/index.ts`
- Create: `stories/poc/src/testing/gameplay-fixture.ts`
- Create: `stories/poc/src/test/gameplay-contract.test.ts`
...
```ts
// stories/poc/src/test/gameplay-contract.test.ts
...
```ts
// stories/poc/src/gameplay/contracts/module-catalog.ts
...
```ts
// stories/poc/src/testing/gameplay-fixture.ts
...
```bash
git add -- stories/poc/package.json stories/poc/tsconfig.json stories/poc/src/gameplay/contracts stories/poc/src/gameplay/index.ts stories/poc/src/testing/gameplay-fixture.ts stories/poc/src/test/gameplay-contract.test.ts
...
- Create: `stories/poc/src/gameplay/modules/run/contract.ts`
- Create: `stories/poc/src/gameplay/modules/run/module.ts`
- Create: `stories/poc/src/gameplay/modules/calendar/contract.ts`
- Create: `stories/poc/src/gameplay/modules/calendar/module.ts`
- Create: `stories/poc/src/test/run-calendar.test.ts`
- Modify: `stories/poc/src/gameplay/index.ts`
...
```bash
git add -- stories/poc/src/gameplay/modules/run stories/poc/src/gameplay/modules/calendar stories/poc/src/test/run-calendar.test.ts stories/poc/src/gameplay/index.ts
...
- Create: `stories/poc/src/gameplay/modules/actors/contract.ts`
- Create: `stories/poc/src/gameplay/modules/actors/module.ts`
- Create: `stories/poc/src/gameplay/modules/status/contract.ts`
- Create: `stories/poc/src/gameplay/modules/status/module.ts`
- Create: `stories/poc/src/gameplay/rules/relationship-transition-rule.ts`
- Create: `stories/poc/src/test/actors-status.test.ts`
- Modify: `stories/poc/src/gameplay/index.ts`
...
```bash
git add -- stories/poc/src/gameplay/modules/actors stories/poc/src/gameplay/modules/status stories/poc/src/gameplay/rules/relationship-transition-rule.ts stories/poc/src/test/actors-status.test.ts stories/poc/src/gameplay/index.ts
...
- Create: `stories/poc/src/gameplay/modules/inventory/contract.ts`
- Create: `stories/poc/src/gameplay/modules/inventory/module.ts`
- Create: `stories/poc/src/test/inventory.test.ts`
- Modify: `stories/poc/src/gameplay/index.ts`
...
```bash
git add -- stories/poc/src/gameplay/modules/inventory stories/poc/src/test/inventory.test.ts stories/poc/src/gameplay/index.ts
...
- Create: `stories/poc/src/gameplay/modules/facilities/contract.ts`
- Create: `stories/poc/src/gameplay/modules/facilities/module.ts`
- Create: `stories/poc/src/gameplay/modules/tavern/contract.ts`
- Create: `stories/poc/src/gameplay/modules/tavern/module.ts`
- Create: `stories/poc/src/test/facilities-tavern.test.ts`
- Modify: `stories/poc/src/gameplay/index.ts`
...
```bash
git add -- stories/poc/src/gameplay/modules/facilities stories/poc/src/gameplay/modules/tavern stories/poc/src/test/facilities-tavern.test.ts stories/poc/src/gameplay/index.ts
...
- Create: `stories/poc/src/gameplay/modules/workflow/contract.ts`
- Create: `stories/poc/src/gameplay/modules/workflow/module.ts`
- Create: `stories/poc/src/gameplay/modules/progression/contract.ts`
- Create: `stories/poc/src/gameplay/modules/progression/module.ts`
- Create: `stories/poc/src/test/workflow-progression.test.ts`
- Modify: `stories/poc/src/gameplay/index.ts`
...
```bash
git add -- stories/poc/src/gameplay/modules/workflow stories/poc/src/gameplay/modules/progression stories/poc/src/test/workflow-progression.test.ts stories/poc/src/gameplay/index.ts
...
- Create: `stories/poc/src/gameplay/modules/narrative/contract.ts`
- Create: `stories/poc/src/gameplay/modules/narrative/interpreter.ts`
- Create: `stories/poc/src/gameplay/modules/narrative/module.ts`
- Create: `stories/poc/src/test/narrative.test.ts`
- Modify: `stories/poc/src/gameplay/index.ts`
...
```bash
git add -- stories/poc/src/gameplay/modules/narrative stories/poc/src/test/narrative.test.ts stories/poc/src/gameplay/index.ts
...
- Create: `stories/poc/src/gameplay/rules/demand-rules.ts`
- Create: `stories/poc/src/gameplay/rules/ending-rule.ts`
- Create: `stories/poc/src/gameplay/resolvers/tavern-settlement-resolver.ts`
- Create: `stories/poc/src/gameplay/resolvers/check-resolver.ts`
- Create: `stories/poc/src/gameplay/resolvers/scheduling-resolver.ts`
- Create: `stories/poc/src/test/rules-resolvers.test.ts`
- Modify: `stories/poc/src/gameplay/index.ts`
...
```bash
git add -- stories/poc/src/gameplay/rules stories/poc/src/gameplay/resolvers stories/poc/src/test/rules-resolvers.test.ts stories/poc/src/gameplay/index.ts
...
- Create: `stories/poc/src/gameplay/transaction/candidate.ts`
- Create: `stories/poc/src/gameplay/transaction/effect-router.ts`
- Create: `stories/poc/src/test/transaction.test.ts`
- Modify: `stories/poc/src/gameplay/index.ts`
...
```bash
git add -- stories/poc/src/gameplay/transaction stories/poc/src/test/transaction.test.ts stories/poc/src/gameplay/index.ts
...
- Create: `stories/poc/src/gameplay/game-command-executor.ts`
- Create: `stories/poc/src/test/command-executor-core.test.ts`
- Modify: `stories/poc/src/gameplay/contracts/types.ts`
- Modify: `stories/poc/src/gameplay/contracts/schemas.ts`
- Modify: `stories/poc/src/gameplay/index.ts`
...
```bash
git add -- stories/poc/src/gameplay/game-command-executor.ts stories/poc/src/gameplay/contracts/types.ts stories/poc/src/gameplay/contracts/schemas.ts stories/poc/src/test/command-executor-core.test.ts stories/poc/src/gameplay/index.ts
...
- Modify: `stories/poc/src/gameplay/game-command-executor.ts`
- Create: `stories/poc/src/test/command-executor-workflows.test.ts`
- Modify: `stories/poc/src/gameplay/contracts/schemas.ts`
...
```bash
git add -- stories/poc/src/gameplay/game-command-executor.ts stories/poc/src/gameplay/contracts/schemas.ts stories/poc/src/test/command-executor-workflows.test.ts
...
- Modify: `stories/poc/src/gameplay/contracts/schemas.ts`
- Modify: `stories/poc/src/gameplay/contracts/types.ts`
- Create: `stories/poc/src/gameplay/game-debug-command-executor.ts`
- Create: `stories/poc/src/gameplay/game-queries.ts`
- Create: `stories/poc/src/gameplay/game-view-projector.ts`
- Create: `stories/poc/src/gameplay/game-simulation.ts`
- Create: `stories/poc/src/test/game-debug-command-executor.test.ts`
- Create: `stories/poc/src/test/game-queries.test.ts`
- Create: `stories/poc/src/test/game-simulation.test.ts`
- Create: `stories/poc/src/test/game-session-integration.test.ts`
- Modify: `stories/poc/src/gameplay/index.ts`

**Interfaces:**

- Consumes: all ten module bindings, complete State/Command/Fact/Rejection/replayable-Debug schemas, normal executor, transaction candidate, post-Hotfix `program.rules`, Rules/Resolvers, Base `BootstrapEntropyV1`, `GameDebugCommandExecutorV1`, `defineGameSimulation<PocGameSimulationTypesV1>()`, and test-only `createGameSessionV1` from `@project-tavern/base/runtime`.
...
```bash
git add -- stories/poc/src/gameplay/contracts/schemas.ts stories/poc/src/gameplay/contracts/types.ts stories/poc/src/gameplay/game-debug-command-executor.ts stories/poc/src/gameplay/game-queries.ts stories/poc/src/gameplay/game-view-projector.ts stories/poc/src/gameplay/game-simulation.ts stories/poc/src/test/game-debug-command-executor.test.ts stories/poc/src/test/game-queries.test.ts stories/poc/src/test/game-simulation.test.ts stories/poc/src/test/game-session-integration.test.ts stories/poc/src/gameplay/index.ts
...
```bash
git add -- scripts/verify-poc-gameplay.mts scripts/verify-poc-gameplay.test.mjs package.json stories/poc/package.json
git commit -m "test(story-poc): add gameplay verification gate"
```

## Phase 4A Acceptance

- [ ] All tavern-specific software in this phase is under `stories/poc/src/gameplay`; Base/UI/Web/E2E contain no PoC state, ID, rule, relationship, or tavern semantics.
