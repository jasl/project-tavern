...
Set `verify:ui="node --experimental-strip-types scripts/ui/verify-ui.mts"`. It uses structured command/arg arrays, runs against already built Demo Player, Demo Developer, and E2E Player outputs, never builds, and never updates screenshots. WebKit remains the explicit phase/release expansion.
