...
```text
packages/ui/src/assets/                 # exact-AssetId registry, read port, generic code fallback
packages/ui/src/runtime/                # atomic SemanticPublication external-store bridge
packages/ui/src/contributions/          # seven neutral renderer namespaces
packages/ui/src/symbols/                # Story-supplied world-semantic GameSymbol registry
packages/ui/src/input/                  # device-independent input events, contexts, router
packages/ui/src/theme/                  # tokens, focus, reduced-motion and responsive rules
packages/ui/src/primitives/             # semantic buttons, icon buttons and meters
packages/ui/src/shell/                  # GameShell, fixed seven-layer Stage and top HUD slots
packages/ui/src/overlays/               # one primary workspace overlay plus bounded details
packages/ui/src/narrative/              # blocking VN layer and Narrative input context
packages/ui/src/system/                 # highest-priority dialogs
packages/ui/src/persistence/            # four-slot Save/Load/Import/Export surface
packages/ui/src/errors/                 # root error boundary and runtime-failure recovery
packages/ui/src/diagnostics/            # always-reachable player-safe DebugBundle export
apps/web/src/assets/                    # browser URL resolution and image decode adapter
apps/web/src/input/                     # Pointer Events, viewport point, cancel and focus-loss
stories/e2e/src/application/            # existing Phase-2 root compatibility at task checkpoints
stories/e2e/src/presentation/           # existing neutral renderer namespace migration only
...
- Create: `packages/ui/src/assets/code-native-asset-fallback.tsx`
- Create: `packages/ui/src/assets/code-native-asset-fallback.test.tsx`
- Create: `packages/ui/src/assets/presentation-read-port.ts`
- Create: `packages/ui/src/assets/presentation-read-port.test.ts`
- Create: `packages/ui/src/assets/use-presentation-asset.ts`
- Create: `packages/ui/src/assets/use-presentation-asset.test.tsx`
- Create: `packages/ui/src/assets/index.ts`
- Create: `packages/ui/type-tests/assets-public.test-d.ts`
- Modify: `packages/ui/package.json`
- Create: `apps/web/src/assets/create-browser-image-loader.ts`
- Create: `apps/web/src/assets/create-browser-image-loader.test.ts`
- Create: `apps/web/src/assets/index.ts`
...
- Produces: public `@project-tavern/ui/assets`, `createAssetRegistryV1`, `AssetRegistryV1`, cached `AssetRegistryPublicationV1`, `createPresentationReadPortV1`, `usePresentationAssetV1`, `CodeNativeAssetFallbackV1`, and Web-owned `createBrowserImageLoaderV1`.
...
```bash
pnpm --filter @project-tavern/ui exec vitest run src/assets
pnpm --filter @project-tavern/web exec vitest run src/assets
```
...
```bash
git add -- packages/ui/src/assets packages/ui/type-tests/assets-public.test-d.ts packages/ui/package.json apps/web/src/assets apps/web/src/index.ts
git diff --cached --name-only
git diff --cached --check
git commit -m "feat(ui): add demand-driven asset presentation"
```

Expected staged paths are only `packages/ui/src/assets/**`, `packages/ui/type-tests/assets-public.test-d.ts`, `packages/ui/package.json`, `apps/web/src/assets/**`, and `apps/web/src/index.ts`.
...
- Create: `packages/ui/src/runtime/semantic-publication-bridge.ts`
- Create: `packages/ui/src/runtime/semantic-publication-bridge.test.ts`
- Create: `packages/ui/src/runtime/use-semantic-publication.ts`
...
- Create: `packages/ui/src/symbols/game-symbol.tsx`
- Create: `packages/ui/src/symbols/game-symbol.test.tsx`
- Create: `packages/ui/src/symbols/game-symbol-registry.ts`
- Create: `packages/ui/src/symbols/game-symbol-registry.test.ts`
- Create: `packages/ui/src/symbols/index.ts`
- Modify: `packages/ui/src/shell/game-shell.tsx`
- Modify: `packages/ui/src/shell/game-shell.test.tsx`
- Modify: `packages/ui/src/index.ts`
- Create: `packages/ui/type-tests/runtime-public.test-d.ts`
- Modify: `stories/e2e/src/presentation/e2e-renderers.tsx`
- Modify: `stories/e2e/src/presentation/e2e-renderers.test.tsx`
...
```bash
pnpm --filter @project-tavern/ui exec vitest run src/contributions src/runtime src/symbols
```
...
```bash
git add -- packages/ui/src/contributions packages/ui/src/runtime packages/ui/src/symbols packages/ui/src/shell/game-shell.tsx packages/ui/src/shell/game-shell.test.tsx packages/ui/src/index.ts packages/ui/type-tests/runtime-public.test-d.ts stories/e2e/src/presentation/e2e-renderers.tsx stories/e2e/src/presentation/e2e-renderers.test.tsx stories/e2e/src/application/e2e-application-root.tsx stories/e2e/src/application/e2e-application-root.test.tsx
git diff --cached --name-only
git diff --cached --check
git commit -m "feat(ui): bridge atomic semantic publications"
```

Expected staged paths are only `packages/ui/src/contributions/**`, `packages/ui/src/runtime/**`, `packages/ui/src/symbols/**`, the listed `GameShell`/E2E migration files, `packages/ui/src/index.ts`, and `packages/ui/type-tests/runtime-public.test-d.ts`.
...
- Modify: `packages/ui/src/index.ts`
- Create: `packages/ui/type-tests/input-public.test-d.ts`
- Create: `apps/web/src/input/install-pointer-adapter.ts`
- Create: `apps/web/src/input/install-pointer-adapter.test.ts`
...
```bash
pnpm --filter @project-tavern/ui exec vitest run src/input
pnpm --filter @project-tavern/web exec vitest run src/input
```
...
```bash
git add -- packages/ui/src/input packages/ui/src/index.ts packages/ui/type-tests/input-public.test-d.ts apps/web/src/input apps/web/src/index.ts
git diff --cached --name-only
git diff --cached --check
git commit -m "feat(input): add stage pointer routing"
```

Expected staged paths are only `packages/ui/src/input/**`, `packages/ui/src/index.ts`, `packages/ui/type-tests/input-public.test-d.ts`, `apps/web/src/input/**`, and `apps/web/src/index.ts`.
...
- Create: `packages/ui/src/shell/stage-layout.ts`
- Create: `packages/ui/src/shell/stage-layout.test.ts`
- Create: `packages/ui/src/shell/top-card-hud.tsx`
- Create: `packages/ui/src/shell/top-card-hud.test.tsx`
- Modify: `packages/ui/src/shell/game-shell.tsx`
...
```bash
pnpm --filter @project-tavern/ui exec vitest run src/primitives src/shell
pnpm lint:styles
```
...
Add root script `"lint:styles": "stylelint \"packages/**/*.css\" \"stories/**/*.css\" \"apps/**/*.css\""`. `.stylelintrc.json` extends only `stylelint-config-standard` and contains reviewed CSS Modules selector exceptions; it does not disable unknown-property, duplicate-property, contrast, or syntax failures globally.
...
- Create: `packages/ui/src/overlays/overlay-session-store.test.ts`
- Create: `packages/ui/src/overlays/overlay-host.tsx`
- Create: `packages/ui/src/overlays/overlay-host.module.css`
- Create: `packages/ui/src/overlays/overlay-host.test.tsx`
- Create: `packages/ui/src/overlays/action-confirmation-dialog.tsx`
- Create: `packages/ui/src/overlays/action-confirmation-dialog.test.tsx`
- Create: `packages/ui/src/overlays/index.ts`
- Create: `packages/ui/src/narrative/vn-layer.tsx`
- Create: `packages/ui/src/narrative/vn-layer.module.css`
- Create: `packages/ui/src/narrative/vn-layer.test.tsx`
- Create: `packages/ui/src/narrative/index.ts`
- Create: `packages/ui/src/system/system-dialog-host.tsx`
- Create: `packages/ui/src/system/system-dialog-host.test.tsx`
- Create: `packages/ui/src/system/settings-launcher.tsx`
- Create: `packages/ui/src/system/settings-launcher.test.tsx`
- Create: `packages/ui/src/system/settings-dialog.tsx`
- Create: `packages/ui/src/system/settings-dialog.test.tsx`
...
```bash
pnpm --filter @project-tavern/ui exec vitest run src/overlays src/narrative src/system
```
...
```bash
pnpm --filter @project-tavern/ui exec vitest run src/overlays src/narrative src/system src/input src/shell
pnpm lint:styles
pnpm typecheck
pnpm verify:boundaries
pnpm verify:ui
...
- Create: `packages/ui/src/persistence/save-overlay.tsx`
- Create: `packages/ui/src/persistence/save-overlay.module.css`
- Create: `packages/ui/src/persistence/save-overlay.test.tsx`
- Create: `packages/ui/src/persistence/index.ts`
- Create: `packages/ui/src/errors/root-error-boundary.tsx`
- Create: `packages/ui/src/errors/runtime-failure-dialog.tsx`
- Create: `packages/ui/src/errors/errors.test.tsx`
- Create: `packages/ui/src/errors/index.ts`
...
- Create: `packages/ui/src/diagnostics/index.ts`
- Modify: `packages/ui/src/shell/game-shell.tsx`
- Modify: `packages/ui/src/index.ts`
...
```bash
pnpm --filter @project-tavern/ui exec vitest run src/persistence src/errors src/diagnostics
```
...
```bash
pnpm --filter @project-tavern/ui exec vitest run src/persistence src/errors src/diagnostics src/overlays src/system
pnpm lint:styles
pnpm typecheck
pnpm verify:boundaries
pnpm verify:ui
...
```bash
git add -- packages/ui/src/persistence packages/ui/src/errors packages/ui/src/diagnostics packages/ui/src/shell/game-shell.tsx packages/ui/src/index.ts
git diff --cached --name-only
git diff --cached --check
git commit -m "feat(ui): add persistence and recovery surfaces"
```

Expected staged paths are only the listed persistence/errors/diagnostics modules, `game-shell.tsx`, and `packages/ui/src/index.ts`.
...
it("reads only exact runtime providers and never enumerates source archives", async () => {
  ...
  expect(reads).toEqual(["packages/assets/e2e/scene.png"]);
  expect(
...
test("freezes the inspect-only UI command list", async () => {
  ...
  assert.deepEqual(uiRuntimeVerificationCommandsV1, [
    ...
    [
      "pnpm",
      ["--filter", "@project-tavern/web", "exec", "vitest", "run", "src/assets", "src/input"],
    ],
...
Plan complete. Execute with `superpowers:subagent-driven-development` task-by-task, using a fresh implementation subagent and specification/code-quality review at every commit boundary. `superpowers:executing-plans` is the fallback when implementation must stay in one session; do not combine tasks or skip their red/green verification checkpoints.
